...
pub fn sprite_data(board: BoardTheme, pieces: PieceSet) -> &'static [u8] {
    ...
    match board {
        ...
        BoardTheme::Pink => match pieces {
            Alpha => include_bytes!("../theme/sprites/ping-alpha.gif"),
            Anarcandy => include_bytes!("../theme/sprites/ping-anarcandy.gif"),
            California => include_bytes!("../theme/sprites/ping-california.gif"),
            Cardinal => include_bytes!("../theme/sprites/ping-cardinal.gif"),
            Cburnett => include_bytes!("../theme/sprites/ping-cburnett.gif"),
            Chess7 => include_bytes!("../theme/sprites/ping-chess7.gif"),
            Chessnut => include_bytes!("../theme/sprites/ping-chessnut.gif"),
            Companion => include_bytes!("../theme/sprites/ping-companion.gif"),
            Disguised => include_bytes!("../theme/sprites/ping-disguised.gif"),
            Dubrovny => include_bytes!("../theme/sprites/ping-dubrovny.gif"),
            Fantasy => include_bytes!("../theme/sprites/ping-fantasy.gif"),
            Fresca => include_bytes!("../theme/sprites/ping-fresca.gif"),
            Gioco => include_bytes!("../theme/sprites/ping-gioco.gif"),
